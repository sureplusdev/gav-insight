...
// Novos slides consolidados
import ContextoFomento2026Slide from "@/components/presentation/slides/ContextoFomento2026Slide";
...
export default function Presentation() {
  ...
  const slides = [
    ...
    <ContextoFomento2026Slide key={1} />,
    <ProblemSlide key={2} />,
    <SolutionSlide key={3} />,
  ...
  return (
    <div className="min-h-screen overflow-x-hidden" style={{ backgroundColor: "#193A62" }}>
      ...
      <SlideNav current={currentSlide} total={TOTAL_SLIDES} onPrev={goPrev} onNext={goNext} />
