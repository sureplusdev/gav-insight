  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-brand-900">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-1/4 -right-32 w-96 h-96 bg-brand-400/8 rounded-full blur-3xl animate-pulse delay-1000" />
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-brand-500/20 bg-brand-500/5">
            ...
            <span className="text-xs font-medium text-brand-500 tracking-wider uppercase">
        ...
        <motion.p
          ...
          className="mt-4 text-lg md:text-xl text-brand-500 font-medium tracking-wide"
        >
        ...
        >
          <button
            onClick={onNext}
            className="group flex items-center gap-3 px-8 py-4 bg-brand-500 hover:bg-brand-400 text-white font-semibold rounded-full transition-all duration-300 hover:shadow-lg hover:shadow-brand-500/25"
          >
